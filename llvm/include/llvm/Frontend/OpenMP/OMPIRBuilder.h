...
public:
  ...
  /// List of global values which are generated by OMPIRBuilder and
  /// they are required to be present in object file;
  SmallVector<WeakTrackingVH> LLVMCompilerUsed;
  ...
  static llvm::GlobalVariable *createExecModeProperty(StringRef Name, bool Mode,
                                                      Module &M,
                                                      LLVMContext &Context);
...
public:
  ...
  /// \param BodyGenCB Callback that will generate the region code.
  /// \param IsSPMD Information about execution mode (SPMD or Generic)
