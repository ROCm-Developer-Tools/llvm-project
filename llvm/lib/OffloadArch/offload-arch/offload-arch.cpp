...
/// The offload-arch tool has alias commands "amdgpu-arch", "nvidia-arch".
/// and "intelhd-arch". The alias commands are symbolic links to offload-arch.
///
