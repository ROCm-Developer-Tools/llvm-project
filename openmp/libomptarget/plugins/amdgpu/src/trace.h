...
static int32_t __tgt_rtl_set_coarse_grain_mem_region_impl(const void *ptr, int64_t size);
int32_t __tgt_rtl_set_coarse_grain_mem_region(const void *ptr, int64_t size) {
