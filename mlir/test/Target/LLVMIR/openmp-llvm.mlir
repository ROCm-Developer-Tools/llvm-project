...
// NOTE: This test unfortunately only checks the host side, as the device side is dependent 
// on a *.bc file created by the host and appended as an attribute to the module.
